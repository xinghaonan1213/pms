...
<link rel="stylesheet" type="text/css" href="skin/css/main.css" />
	...
	<script type="text/javascript">
		$(function () {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/notice/latesNoticeList",
		...
		function showWindow(nid) {
		    $.ajax({
				...
				success:function (msg) {
				    $("#ntitle").text(msg.ntitle).css({"font-size":"20px","font-weight":"bold"});
				    $("#content").text(msg.remark).css({"font-size":"30px"});
                    $("#showdiv").show();
...
<div id="showdiv" style="width: 60%; margin: 0 auto; height:500px; border: 1px solid #999; display: none; position: absolute; top: 20%; left: 20%; z-index: 3; background: #fff">
	<!-- 标题 -->
	<div id="ntitle" style="background: #F8F7F7; width: 100%; height: 3rem; font-size: 2rem; line-height: 4rem; border: 3px solid #999; text-align: center;" >
