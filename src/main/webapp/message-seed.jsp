...
<title>发信息</title>
	...
	<script type="text/javascript">
		//就绪函数，当点击发进入发信息界面就开始查询出收件人(员工)的名字
		$(function () {
			//异步请求
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/emp/getReceiver",
...
<tr>
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<img onclick="WdatePicker({el:'date'})" src="${pageContext.request.contextPath}/static/js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
	</td>
</tr>
<tr >
